  ...
  return (
    <div ref={certificateRef} className="fixed left-[10000px] top-[10000px] -z-10 py-8 font-condensed bg-[url('/uzturk-flag.png')] bg-cover bg-center w-[1123px] h-[794px] bg-white border-8 border-yellow-500 px-20 mx-auto">
      ...
      <div className="text-center">
        <h1 className="mt-8 mb-8 text-8xl font-bold text-yellow-500">100% SERTIFIKAT</h1>
        <p className="text-xl text-white">
          nomli online turk tili kursimizda o'qib hali sertifikatga
          <br /> erishmagan o'quvchilarimiz uchun kursda qayta o'qish uchun
        </p>
      </div>
      ...
      <div className="mt-12 text-center">
        ...
        <h1 className="font-bold uppercase text-6xl px-4 mb-10 font-cursive text-yellow-500 mt-4 inline-block">
          100.000 SO'MLIK VAUCHER
        </h1>
        <div className="mx-32 h-[1px] bg-white"></div>
        <p className="text-xl text-white">
          Kursimizda qayta o'qib imtihonlarda 100% sertifikatli bo'lishingiz tilakdoshimiz !
        </p>
      </div>
      ...
      <div className="text-center mt-10">
        <p className="text-white">15.10.2025</p>
      </div>
    </div>
  );
};
