      ...
      <div className="container pt-4 pb-8 text-center">
        ...
        <div className="relative max-w-xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-4">
            <button onClick={() => { window.location.href = 'https://t.me/irodahoca_support_bot?start=kurs'; }} className="flex -mt-14 z-10 font-bold bg-red-600 text-white px-12 py-2 rounded-xl text-xl hover:bg-red-700 transition-colors animate-pulseGlow">
              RO'YXATDAN O'TISH
            </button>
          </div>
          ...
          <div className="flex items-center justify-center gap-4 mt-10">
            <button onClick={() => { window.location.href = 'https://t.me/irodahoca_support_bot?start=kurs'; }} className="flex font-bold bg-red-600 text-white px-12 py-2 rounded-xl text-xl hover:bg-red-700 transition-colors animate-pulseGlow">
              RO'YXATDAN O'TISH
            </button>
          </div>
        </div>
