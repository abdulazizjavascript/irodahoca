  ...
  return (
    <div ref={certificateRef} className="fixed left-[10000px] top-[10000px] -z-10 py-8 font-condensed bg-[url('/uzturk-flag.png')] bg-cover bg-center w-[1123px] h-[794px] bg-white border-8 border-yellow-500 px-20 mx-auto">
      ...
      <div className="text-center">
        ...
        <p className="text-xl text-white"> Turk tiliga ixtisoslashgan UZTURK o'quv markazi o'quv kursni <br /> tamomlaganligi uchun</p>
      </div>
      ...
      <div className="mt-12 text-center">
        ...
        <p className="text-xl text-white">
          Kelayotgan imtihonlarda sertifikatni 100% naqd qilishingiz tilakdoshimiz !
        </p>
      </div>
